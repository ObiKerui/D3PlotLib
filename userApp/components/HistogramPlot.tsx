...
function createHistogram(ref: any) {
    ...
    let scaler = d3PlotLib.Scaler()
      ...
      .yScale((ys: any) => {
        return d3.scaleLinear()
        .domain(d3.extent(pdf_norm))
        .nice()
      })
  
    let hist1 = d3PlotLib.Hist()
    .xs(ms)
    .ys(logmass1)
    .bins(100)
    .density(true)
    ...
    let fillBetween = d3PlotLib.FillArea()
    .xs(ms)
    .ys(pdf_norm)
    .alpha(0.2)
    .where(condition)
      ...
      <div className='plot'>
        <div className="plot plot--container">
          ...
          <div className="plot plot--description">
            <p>Histogram plot is for rendering such n such. Good for which types of visual, bad for these others..etc.</p>
          </div>
        </div>
